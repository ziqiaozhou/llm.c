...
pub(crate) fn layernorm_forward<'ctx, CN: GpuCtxSpace>(
    ...
    inp: &TensorViewMut<'_, [f32]>,
    weight: &TensorViewMut<'_, [f32]>,
    bias: &TensorViewMut<'_, [f32]>,
    batch_size: usize,
    seq_len: usize,
    channel: usize,
) {
...
pub(crate) fn layernorm_backward<'ctx, CN: GpuCtxSpace>(
    ...
    dout: &TensorViewMut<'_, [f32]>,
    inp: &TensorViewMut<'_, [f32]>,
    weight: &TensorViewMut<'_, [f32]>,
    mean: &TensorViewMut<'_, [f32]>,
    rstd: &TensorViewMut<'_, [f32]>,
    batch_size: usize,
    seq_len: usize,
    channel: usize,
) {
...
pub(crate) fn attention_backward<'ctx, CN: GpuCtxSpace>(
    ...
    dout: &TensorView<'_, [f32]>,
    qkvr: &TensorViewMut<'_, [f32]>,
    att: &TensorViewMut<'_, [f32]>,
    batch_size: usize,
    seq_len: usize,
    channel: usize,
    num_heads: usize,
